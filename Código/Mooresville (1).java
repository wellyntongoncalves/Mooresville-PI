...
package com.mycompany.mooresville;
        ...
        while (true) {
           ...
           System.out.println("                        ░░░┼░░░░░░░░░░░┼░░░┼░░░░░░░░┼░░░░░░░░");
            ...
            if (start.equals("start")) {
                System.out.println(" Meu tio Tyler era uma das personalidades mais bizarras que se pode imaginar, mas nem sempre ele foi assim. \n" +
...
//seguir para outro quarto e ler a carta na mesa:
                ...
                if (luta1==1) {
                    ...
                    if (luta11==1) {
                        ...
                        System.out.println("dano: " + danochutedog);
                        vidaCachorro = vidaCachorro - danochutedog;
                        System.out.println(" total vida Cachorro deformado: " + vidaCachorro);
                       ...
                       vida = vida -danoVsDog ;
                        System.out.print("seu total de vida restante:" +vida);
                        System.out.println("cachorro deformado dano: " + criticalhit + " (critical hit)");
                        vidaCachorro = vidaCachorro - criticalhit;
                        System.out.println("vida  cachorro deformado:" + vidaCachorro);
                    ...
                    if (luta11==2) {
                        ...
                        vidaCachorro = vidaCachorro - danoMorte;
                        System.out.println("  vida Cachorro deformado: " + vidaCachorro);
                        System.out.print("dano sofrido:  " + mordida);
                        vida = vida - mordida;
                        System.out.println("seu total de vida:" + vida);
                ...
                if (luta1==2) {
                    ...
                    if (faca==1) {
                        ...
                        if (luta12==1) {
                            ...
                            System.out.println("cachorro deformado dano: " + criticalhit + "(critical hit)");
                            vidaCachorro = vidaCachorro -criticalhit;
                            System.out.print("vida  cachorro deformado:" + vida);
                            System.out.println("_____você venceu a luta.___");
                            System.out.println("após finalizar o monstro, você investiga o corpo com frieza e percebe que o animal foi modificado cientificamente.");
                        ...
                        if (luta12==2) {
                            ...
                            vidaCachorro = vidaCachorro - criticalhit;
                            System.out.println("total de vida cachorro deformado: " + vidaCachorro);
                            System.out.println("_____você venceu a luta.___");
                            System.out.println("após finalizar o monstro, você investiga o corpo com frieza e percebe que o animal foi modificado cientificamente.");
                            System.out.println("tomado  por adrenalina você apenas pega seu lampião do chão, vira as costas e volta sentido a escada para subir  e terminar de investigar o resto do corredor.");
                        }
 ...
 int morte = scan.nextInt();
                if (morte==1) {
                  ...
                  vida = vida - danoMorte;
                    System.out.println("total de vida : " + vida);
                    ...
                    if (tyler==1) {
                        ...
                        if (combate1==1) {
                            ...
                            if (AcertarBoca==1) {
                                ...
                                tiotyler = tiotyler - boca;
                                System.out.println("tio tyler total vida: " + tiotyler);
                        ...
                        if (combate1==2) {
                            ...
                            tiotyler = tiotyler - mordida;
                            System.out.println(" tio tyler total vida: " + tiotyler);
                            System.out.println("dano sofrido: " + danoVsDog);
                            vida = vida - danoVsDog;
                            System.out.println("seu total de vida restante: " + vida + " ~~sangrando~~");
                        }
...
// decisão 1 ou 2 vai te levar a :   
                        ...
                        if (decisao==1) {
                            ...
                            vida = vida - mordida;
                            System.out.println("total de vida restante: " + vida);
                            ...
                            vida = vida - danoInicio;
                            System.out.println("Seu Total de vida restante: " + vida);
                        }
                        ...
                        if (fatality==1) {
                            ...
                            tiotyler = tiotyler - criticalhit;
                            System.out.println("vida tyler:" + tiotyler);
                            System.out.println("_____você venceu a luta.___");
                        }
                        //se fatality 2.
                        if (fatality==2) {
                    ...
                    if (tyler==2) {
                        ...
                        if (chutar==1) {
                         ...
                         tiotyler = tiotyler-mordida;
                            ...
                            tiotyler = tiotyler - danoMorte;
                            System.out.println("vida  de tio tyler: " + tiotyler);
